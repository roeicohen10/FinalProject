...
class AlphaInvesting(OnlineFeatureSelectionAC):
    """
    implementation of Alpha Investing algorithm
    """
    DEFAULT_PARAMS = {"alpha": 0.05, "dw": 0.05}
    def __init__(self):
        super().__init__(name='Alpha Investing', parameters=AlphaInvesting.DEFAULT_PARAMS)

    def run(self, X, Y):
        return AlphaInvesting.alpha_investing(X, Y, self.parameters['alpha'], self.parameters['dw'])

    @classmethod
    def alpha_investing(cls, X, y, w0, dw):
        """
